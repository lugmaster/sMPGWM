...
public static partial class Steam
{
    ...
    // TODO verify if an library update occurs
    public static SteamInitResult SteamInit(uint appId, bool embedCallbacks)
    {
        var raw = GetInstance().Call(Methods.SteamInit, appId, embedCallbacks).AsGodotDictionary();
    ...
    {
        var raw = GetInstance().Call(Methods.SteamInitEx, appId, embedCallbacks).AsGodotDictionary();
